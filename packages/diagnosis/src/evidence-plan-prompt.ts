...
`
  ...
  const systemFollowupInstruction = input.isSystemFollowup
    ? `
IMPORTANT: This question was generated by the system as a suggested follow-up. DO NOT choose "clarification". Provide the best answer available using the current evidence. If you are uncertain, choose "answer" and note the uncertainty in the rewrittenQuestion.
`
    : "";
