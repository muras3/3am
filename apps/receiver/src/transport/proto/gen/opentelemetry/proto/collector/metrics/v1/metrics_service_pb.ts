...
import type { ResourceMetrics, ResourceMetricsJson } from "../../../metrics/v1/metrics_pb.js";
 ...
 * @generated from message opentelemetry.proto.collector.metrics.v1.ExportMetricsServiceRequest
 */
export type ExportMetricsServiceRequestJson = {
  /**
   * An array of ResourceMetrics.
   * For data coming from a single resource this array will typically contain one
   * element. Intermediary nodes (such as OpenTelemetry Collector) that receive
 ...
 */
export const ExportMetricsServiceRequestSchema: GenMessage<ExportMetricsServiceRequest, {jsonType: ExportMetricsServiceRequestJson}> = /*@__PURE__*/
 ...
 * @generated from message opentelemetry.proto.collector.metrics.v1.ExportMetricsServiceResponse
 */
export type ExportMetricsServiceResponseJson = {
  /**
   * The details of a partially successful export request.
   *
   * If the request is only partially accepted
   ...
   * @generated from field: opentelemetry.proto.collector.metrics.v1.ExportMetricsPartialSuccess partial_success = 1;
   */
  partialSuccess?: ExportMetricsPartialSuccessJson;
};
 ...
 */
export const ExportMetricsServiceResponseSchema: GenMessage<ExportMetricsServiceResponse, {jsonType: ExportMetricsServiceResponseJson}> = /*@__PURE__*/
 ...
 * @generated from message opentelemetry.proto.collector.metrics.v1.ExportMetricsPartialSuccess
 */
export type ExportMetricsPartialSuccessJson = {
  /**
   * The number of rejected data points.
   *
   * A `rejected_<signal>` field holding a `0` value indicates that the
 ...
 */
export const ExportMetricsPartialSuccessSchema: GenMessage<ExportMetricsPartialSuccess, {jsonType: ExportMetricsPartialSuccessJson}> = /*@__PURE__*/
