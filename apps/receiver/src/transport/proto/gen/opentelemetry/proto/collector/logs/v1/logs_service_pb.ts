...
import type { ResourceLogs, ResourceLogsJson } from "../../../logs/v1/logs_pb.js";
 ...
 * @generated from message opentelemetry.proto.collector.logs.v1.ExportLogsServiceRequest
 */
export type ExportLogsServiceRequestJson = {
  /**
   * An array of ResourceLogs.
   * For data coming from a single resource this array will typically contain one
   * element. Intermediary nodes (such as OpenTelemetry Collector) that receive
 ...
 */
export const ExportLogsServiceRequestSchema: GenMessage<ExportLogsServiceRequest, {jsonType: ExportLogsServiceRequestJson}> = /*@__PURE__*/
 ...
 * @generated from message opentelemetry.proto.collector.logs.v1.ExportLogsServiceResponse
 */
export type ExportLogsServiceResponseJson = {
  /**
   * The details of a partially successful export request.
   *
   * If the request is only partially accepted
   ...
   * @generated from field: opentelemetry.proto.collector.logs.v1.ExportLogsPartialSuccess partial_success = 1;
   */
  partialSuccess?: ExportLogsPartialSuccessJson;
};
 ...
 */
export const ExportLogsServiceResponseSchema: GenMessage<ExportLogsServiceResponse, {jsonType: ExportLogsServiceResponseJson}> = /*@__PURE__*/
 ...
 * @generated from message opentelemetry.proto.collector.logs.v1.ExportLogsPartialSuccess
 */
export type ExportLogsPartialSuccessJson = {
  /**
   * The number of rejected log records.
   *
   * A `rejected_<signal>` field holding a `0` value indicates that the
 ...
 */
export const ExportLogsPartialSuccessSchema: GenMessage<ExportLogsPartialSuccess, {jsonType: ExportLogsPartialSuccessJson}> = /*@__PURE__*/
