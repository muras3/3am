...
import type { InstrumentationScope, InstrumentationScopeJson, KeyValue, KeyValueJson } from "../../common/v1/common_pb.js";
 ...
 */
export const MetricsDataSchema: GenMessage<MetricsData, {jsonType: MetricsDataJson}> = /*@__PURE__*/
 ...
 * @generated from message opentelemetry.proto.metrics.v1.ResourceMetrics
 */
export type ResourceMetricsJson = {
  /**
   * The resource for the metrics in this message.
   * If this field is not set then no resource info is known.
   *
 ...
 */
export const ResourceMetricsSchema: GenMessage<ResourceMetrics, {jsonType: ResourceMetricsJson}> = /*@__PURE__*/
 ...
 */
export const ScopeMetricsSchema: GenMessage<ScopeMetrics, {jsonType: ScopeMetricsJson}> = /*@__PURE__*/
...
export type MetricJson = {
   ...
   * @generated from field: opentelemetry.proto.metrics.v1.ExponentialHistogram exponential_histogram = 10;
   */
  exponentialHistogram?: ExponentialHistogramJson;
 ...
 */
export const MetricSchema: GenMessage<Metric, {jsonType: MetricJson}> = /*@__PURE__*/
 ...
 * @generated from message opentelemetry.proto.metrics.v1.Gauge
 */
export type GaugeJson = {
  /**
   * @generated from field: repeated opentelemetry.proto.metrics.v1.NumberDataPoint data_points = 1;
   */
  dataPoints?: NumberDataPointJson[];
};
 ...
 */
export const GaugeSchema: GenMessage<Gauge, {jsonType: GaugeJson}> = /*@__PURE__*/
...
export type SumJson = {
   ...
   * @generated from field: opentelemetry.proto.metrics.v1.AggregationTemporality aggregation_temporality = 2;
   */
  aggregationTemporality?: AggregationTemporalityJson;
 ...
 */
export const SumSchema: GenMessage<Sum, {jsonType: SumJson}> = /*@__PURE__*/
...
export type HistogramJson = {
   ...
   * @generated from field: repeated opentelemetry.proto.metrics.v1.HistogramDataPoint data_points = 1;
   */
  dataPoints?: HistogramDataPointJson[];
 ...
 */
export const HistogramSchema: GenMessage<Histogram, {jsonType: HistogramJson}> = /*@__PURE__*/
 ...
 * @generated from message opentelemetry.proto.metrics.v1.ExponentialHistogram
 */
export type ExponentialHistogramJson = {
  /**
   * @generated from field: repeated opentelemetry.proto.metrics.v1.ExponentialHistogramDataPoint data_points = 1;
   */
  dataPoints?: ExponentialHistogramDataPointJson[];
 ...
 */
export const ExponentialHistogramSchema: GenMessage<ExponentialHistogram, {jsonType: ExponentialHistogramJson}> = /*@__PURE__*/
...
export type SummaryJson = {
   ...
   * @generated from field: repeated opentelemetry.proto.metrics.v1.SummaryDataPoint data_points = 1;
   */
  dataPoints?: SummaryDataPointJson[];
};
 ...
 */
export const SummarySchema: GenMessage<Summary, {jsonType: SummaryJson}> = /*@__PURE__*/
 ...
 * @generated from message opentelemetry.proto.metrics.v1.NumberDataPoint
 */
export type NumberDataPointJson = {
  /**
   * The set of key/value pairs that uniquely identify the timeseries from
   * where this point belongs. The list may be empty (may contain 0 elements).
   * Attribute keys MUST be unique (it is not allowed to have more than one
   ...
   * @generated from field: double as_double = 4;
   */
  asDouble?: number | "NaN" | "Infinity" | "-Infinity";
 ...
 */
export const NumberDataPointSchema: GenMessage<NumberDataPoint, {jsonType: NumberDataPointJson}> = /*@__PURE__*/
 ...
 * @generated from message opentelemetry.proto.metrics.v1.HistogramDataPoint
 */
export type HistogramDataPointJson = {
  /**
   * The set of key/value pairs that uniquely identify the timeseries from
   * where this point belongs. The list may be empty (may contain 0 elements).
   * Attribute keys MUST be unique (it is not allowed to have more than one
   ...
   * @generated from field: optional double sum = 5;
   */
  sum?: number | "NaN" | "Infinity" | "-Infinity";
   ...
   * @generated from field: repeated double explicit_bounds = 7;
   */
  explicitBounds?: (number | "NaN" | "Infinity" | "-Infinity")[];
 ...
 */
export const HistogramDataPointSchema: GenMessage<HistogramDataPoint, {jsonType: HistogramDataPointJson}> = /*@__PURE__*/
 ...
 * @generated from message opentelemetry.proto.metrics.v1.ExponentialHistogramDataPoint
 */
export type ExponentialHistogramDataPointJson = {
  /**
   * The set of key/value pairs that uniquely identify the timeseries from
   * where this point belongs. The list may be empty (may contain 0 elements).
   * Attribute keys MUST be unique (it is not allowed to have more than one
   ...
   * @generated from field: opentelemetry.proto.metrics.v1.ExponentialHistogramDataPoint.Buckets positive = 8;
   */
  positive?: ExponentialHistogramDataPoint_BucketsJson;
   ...
   * @generated from field: opentelemetry.proto.metrics.v1.ExponentialHistogramDataPoint.Buckets negative = 9;
   */
  negative?: ExponentialHistogramDataPoint_BucketsJson;
   ...
   * @generated from field: double zero_threshold = 14;
   */
  zeroThreshold?: number | "NaN" | "Infinity" | "-Infinity";
};
 ...
 */
export const ExponentialHistogramDataPointSchema: GenMessage<ExponentialHistogramDataPoint, {jsonType: ExponentialHistogramDataPointJson}> = /*@__PURE__*/
 ...
 * @generated from message opentelemetry.proto.metrics.v1.ExponentialHistogramDataPoint.Buckets
 */
export type ExponentialHistogramDataPoint_BucketsJson = {
  /**
   * Offset is the bucket index of the first entry in the bucket_counts array.
   *
   * Note: This uses a varint encoding as a simple form of compression.
 ...
 */
export const ExponentialHistogramDataPoint_BucketsSchema: GenMessage<ExponentialHistogramDataPoint_Buckets, {jsonType: ExponentialHistogramDataPoint_BucketsJson}> = /*@__PURE__*/
 ...
 * @generated from message opentelemetry.proto.metrics.v1.SummaryDataPoint
 */
export type SummaryDataPointJson = {
  /**
   * The set of key/value pairs that uniquely identify the timeseries from
   * where this point belongs. The list may be empty (may contain 0 elements).
   * Attribute keys MUST be unique (it is not allowed to have more than one
   ...
   * @generated from field: repeated opentelemetry.proto.metrics.v1.SummaryDataPoint.ValueAtQuantile quantile_values = 6;
   */
  quantileValues?: SummaryDataPoint_ValueAtQuantileJson[];
 ...
 */
export const SummaryDataPointSchema: GenMessage<SummaryDataPoint, {jsonType: SummaryDataPointJson}> = /*@__PURE__*/
 ...
 * @generated from message opentelemetry.proto.metrics.v1.SummaryDataPoint.ValueAtQuantile
 */
export type SummaryDataPoint_ValueAtQuantileJson = {
  /**
   * The quantile of a distribution. Must be in the interval
   * [0.0, 1.0].
   *
   * @generated from field: double quantile = 1;
   */
  quantile?: number | "NaN" | "Infinity" | "-Infinity";
 ...
 */
export const SummaryDataPoint_ValueAtQuantileSchema: GenMessage<SummaryDataPoint_ValueAtQuantile, {jsonType: SummaryDataPoint_ValueAtQuantileJson}> = /*@__PURE__*/
...
export type ExemplarJson = {
   ...
   * @generated from field: repeated opentelemetry.proto.common.v1.KeyValue filtered_attributes = 7;
   */
  filteredAttributes?: KeyValueJson[];
 ...
 */
export const ExemplarSchema: GenMessage<Exemplar, {jsonType: ExemplarJson}> = /*@__PURE__*/
 ...
 * @generated from enum opentelemetry.proto.metrics.v1.AggregationTemporality
 */
export type AggregationTemporalityJson = "AGGREGATION_TEMPORALITY_UNSPECIFIED" | "AGGREGATION_TEMPORALITY_DELTA" | "AGGREGATION_TEMPORALITY_CUMULATIVE";

/**
 * Describes the enum opentelemetry.proto.metrics.v1.AggregationTemporality.
 */
export const AggregationTemporalitySchema: GenEnum<AggregationTemporality, AggregationTemporalityJson> = /*@__PURE__*/
 ...
 * @generated from enum opentelemetry.proto.metrics.v1.DataPointFlags
 */
export type DataPointFlagsJson = "DATA_POINT_FLAGS_DO_NOT_USE" | "DATA_POINT_FLAGS_NO_RECORDED_VALUE_MASK";

/**
 * Describes the enum opentelemetry.proto.metrics.v1.DataPointFlags.
 */
export const DataPointFlagsSchema: GenEnum<DataPointFlags, DataPointFlagsJson> = /*@__PURE__*/
