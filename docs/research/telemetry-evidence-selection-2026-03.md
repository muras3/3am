...
**3amoncall と最もアーキテクチャが近い OSS ツール。**
...
- **3amoncall への適用**: anomalousSignals の時間分布と metric datapoint の時間分布の相関。baseline 不要で動作する
