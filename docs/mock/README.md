...
今回のコンセプトファイルは 3 案を同一ファイルで切り替えつつ、`Open Evidence` で本番データ風の metrics / trace / logs / pf logs を確認できる。
`incident-console-directions-v1.html` は現行 product definition を前提に、ambient な平常時 surface と incident workspace の描き方を 3 パターン比較するための新しい探索モックである。
